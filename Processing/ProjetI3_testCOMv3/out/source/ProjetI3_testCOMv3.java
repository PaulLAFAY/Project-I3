/* autogenerated by Processing revision 1282 on 2022-06-16 */
...
public class ProjetI3_testCOMv3 extends PApplet {
...
class AngleToPoint {
    ...
    public Point[] convertAngle(){
        ...
        pushMatrix();
        translate(PApplet.parseInt(point[1].getX() - BC * cos(radians(angle[0]))), point[1].getY(), PApplet.parseInt(point[1].getZ() - BC * sin(radians(angle[0]))));
        box(20);
        popMatrix();
        ...
        pushMatrix();
        translate(point[2].getX(), PApplet.parseInt(point[2].getY() - CD * cos(radians(angle[1]))), PApplet.parseInt(point[2].getZ() - CD * sin(radians(angle[1]))));
        box(20);
        popMatrix();
        ...
        pushMatrix();
        translate(PApplet.parseInt(point[3].getX() + DE * cos(radians(angle[2]))), point[3].getY(), PApplet.parseInt(point[3].getZ() + DE * sin(radians(angle[2]))));
        box(20);
        popMatrix();
        ...
        pushMatrix();
        translate(point[4].getX(), PApplet.parseInt(point[4].getY() - EF * cos(radians(angle[3]))), PApplet.parseInt(point[4].getZ() - EF * sin(radians(angle[3]))));
        box(20);
        popMatrix();
...
//fonction qui s'active quand un bouton est clické
 public void controlEvent(ControlEvent event){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ProjetI3_testCOMv3" };
    if (passedArgs != null) {
